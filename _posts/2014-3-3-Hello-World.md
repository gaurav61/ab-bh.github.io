...
As usual you will follow the Deep Learning methodology to build the model:<br>
    ...
    &npsb;&nbsp;&nbsp;a. Forward propagation<br>
    &npsb;&nbsp;&nbsp;b. Compute cost function<br>
    &npsb;&nbsp;&nbsp;c. Backward propagation<br>
    &npsb;&nbsp;&nbsp;d. Update parameters (using parameters, and grads from backprop) <br>
